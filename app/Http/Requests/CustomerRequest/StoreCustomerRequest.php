...
class StoreCustomerRequest extends BaseFormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'status'         => 'required|in:active,inactive,pending_activation,block',
        ];
    }
    ...
    public function messages()
    {
        return [
            ...
            'status.required'       => 'Vui lòng chọn trạng thái khách hàng.',
            'status.in'             => 'Trạng thái không hợp lệ. Giá trị cho phép: active, inactive.',
        ];
    }
}
