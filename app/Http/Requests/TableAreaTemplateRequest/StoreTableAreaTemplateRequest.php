...
class StoreTableAreaTemplateRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        return [
            ...
            'name' => ['required', 'string', 'max:100', 'unique:area_templates,name'],
            'description' => ['nullable', 'string', 'max:500'],
            'slug' => ['nullable', 'string', 'max:120', 'unique:area_templates,slug'],
        ];
    }
